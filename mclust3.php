...
//preference is given to the actual choices first...
...
for(i=0;i<jgiver.length;i++)
{
	for(j=0;j<jtaker.length;j++)
		{
			if(jgiver[i].mid!=jtaker[j].mid)//fitering the diagonals out before even calucalting the distance.
			{
...
function findmin(distances)
{
  ...
  return mindist;
	...
	<form id="pool" name="pool" method="post"  action="mclust4.php">
